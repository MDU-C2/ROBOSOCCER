...
#define VL6180X_DEFAULT_I2C_ADDR 0x29 << 1 ///< The fixed I2C addres
...
public:
  ...
  ~Adafruit_VL6180X();
  bool begin(I2C_HandleTypeDef *i2c_dev);
...
private:
  I2C_HandleTypeDef *i2c_dev = NULL; ///< Pointer to I2C bus interface
