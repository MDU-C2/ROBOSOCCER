...
*/
/**************************************************************************/
bool Adafruit_VL6180X::begin(I2C_HandleTypeDef *i2c_dev) {
...
uint8_t Adafruit_VL6180X::read8(uint16_t address) {
  ...
  HAL_I2C_Master_Transmit(i2c_dev, _i2caddr, buffer, 2, 100);
  HAL_I2C_Master_Receive(i2c_dev, _i2caddr, buffer, 1, 100);
  return buffer[0];
}
...
uint16_t Adafruit_VL6180X::read16(uint16_t address) {
  ...
  buffer[1] = uint8_t(address & 0xFF);
  HAL_I2C_Master_Transmit(i2c_dev, _i2caddr, buffer, 2, 100);
  HAL_I2C_Master_Receive(i2c_dev, _i2caddr, buffer, 2, 100);
...
void Adafruit_VL6180X::write8(uint16_t address, uint8_t data) {
  ...
  buffer[1] = uint8_t(address & 0xFF);
  buffer[2] = data;
  HAL_I2C_Master_Transmit(i2c_dev, _i2caddr, buffer, 3, 100);
}
...
void Adafruit_VL6180X::write16(uint16_t address, uint16_t data) {
  ...
  HAL_I2C_Master_Transmit(i2c_dev, _i2caddr, buffer, 4, 100);
}
